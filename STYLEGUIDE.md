...
- [ ] ___Avoid___ putting app logic in the `main.ts`. Instead consider placing it in a component or service.
...
- [ ] ___Avoid___ prefixing private properties and methods with an underscore.
...
- [ ] ___Avoid___ files with multiple components, multiple services, or a mixture.
...
- [ ] ___Avoid___ specifying app-wide singleton providers in a `SharedModule`. Intentional singletons are OK. Take care.
...
- [ ] ___Avoid___ importing the `CoreModule` anywhere except in the `AppModule`.
...
- [ ] ___Avoid___ allowing modules in sibling and parent folders to directly import a module in a *lazy loaded feature*.
...
- [ ] ___Avoid___ renaming inputs and outputs, when possible.
